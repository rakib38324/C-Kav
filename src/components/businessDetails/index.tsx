      ...
      <div className="relative border border-white">
        <div className="w-full h-[450px] mt-[100px] bg-[#F1FAF7] rounded-[40px]">
          <div className="max-w-screen-xl mx-auto">
            ...
            <div className="absolute top-0 left-96 bg-[#75C9B0]  w-[470px] h-[720px] rounded-[20px]">
              ...
              <div className="mx-12 my-10 text-white">
                ...
                <p className="text-base font-normal pt-5  text-[#656E77] font-[#Roboto]">
                  ...
                  eget mauris lorem. Sodales posuere hendrerit risus ullamcorper
                  tristique odio neque faucibus. Gravida tincidunt a nulla
                  ligula netus ut commodo aliquam purus. Senectus purus tortor
                  auctor scelerisque in neque est. Lectus eu enim elit lacinia
                  ut amet. Tortor interdum aliquet amet libero varius nullam
                  rhoncus montes. Massa egestas eget euismod.
                </p>
              </div>
            </div>

            <div className="absolute top-0 right-20 bg-[#75C9B0] w-[370px] h-[720px] rounded-[20px]">
              <div className="mx-12 my-10 text-white">
                <p className="text-xl ">Lawrence Horton</p>
                <p className="text-base font-normal pt-1  text-[#656E77] font-[#Roboto]">
                  Tellus porttitor sit tellus donec.
